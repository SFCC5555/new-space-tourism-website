...
const Menu = ({ menuStatus,setMenuStatus }) => {
  return (
    <section className={`menu ${!menuStatus&&'hidden'} sm:flex absolute sm:relative min-h-screen sm:min-h-0 h-screen p-7 pr-0 sm:py-0 sm:px-5 gap-5 font2 text-sm w-1/2 sm:w-3/4 md:w-96 right-0 top-0 sm:h-auto z-20 flex flex-col sm:flex-row sm:justify-center bg-white/5 backdrop-blur-3xl sm:backdrop-blur-0`} >
