...
const Home = () => {
  return (
    <section className='home absolute top-0 h-screen px-5 pt-28 pb-16 flex flex-col items-center text-center gap-12 sm:flex-row sm:justify-between sm:gap-2 sm:px-14 md:px-24'>
