...
const Home = () => {
  return (
    <section className='home absolute top-0 h-screen px-5 pt-28 flex flex-col items-center text-center gap-12 sm:flex-row sm:justify-between sm:gap-2 sm:px-14 md:px-24'>
        ...
        <div className='flex items-center justify-center w-52 h-52 md:w-64 md:h-64' >
          <div className='exploreButtonContainer flex items-center justify-center w-32 h-32 md:w-48 md:h-48 rounded-full' >
          <Link to={'/DESTINATION'} >
            <div className='flex items-center justify-center text-2xl md:text-3xl font1 w-32 h-32 md:w-48 md:h-48 bg-white colorDark rounded-full cursor-pointer'>
              EXPLORE
            </div>
          </Link>
          </div>
